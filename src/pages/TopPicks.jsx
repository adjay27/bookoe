    ...
    <>
      <div className="relative bg-[#f1f0fe] h-[147px] mx-9 my-4 rounded-[15px] grid content-center">
        <h1 className="text-4xl ml-[71px] font-bold">
          <strong className="text-bookoe">Top</strong> Picks Collection
        </h1>
      </div>
          ...
          {books.map((book, index) => (
            ...
            >
              <div className="img-container row-span-2 grid">
                <div className="relative top-[80px] px-4 w-fit h-9 items-center rounded-full bg-[#8170F2] py-1 text-s font-medium text-white ring-1 ring-inset ring-blue-700/10">
                  {index + 1}
                </div>
                <img
              ...
              <div className="book-info grid w-[260px] ">
                <h1 className="font-bold top-[20px] line-clamp-1 ">
                  {book.title}
                </h1>
